...
@staticmethod
def distance_from_centroid(coordinates_tuple, index_tuples_references_tab, coordinates_categorie):
    liste_centroid = []
    liste_distances = []
    ...
    for centroid in liste_centroid:
        liste_distances.append(euclidean_distance_squared(centroid, coordinates_categorie))
