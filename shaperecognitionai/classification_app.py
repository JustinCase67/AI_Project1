...
class QClassificationWindow(QMainWindow):
    ...
    def __get_info(self):
        ...
        self.__info_layout = QVBoxLayout(group)
    ...
    def __create_single_test(self):
        ...
        self.__single_test_dropmenu.activated.connect(
            lambda: self.set_thumbnail(self.__single_test_dropmenu.current_index))
        ...
        self.__single_test_button.clicked.connect(
            lambda: self.classify_image(self.__current_data_set[self.__single_test_dropmenu.current_index]))
